...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const io_util = __importStar(__nccwpck_require__(962));
...
const test = async () => {
    ...
    const cacheDir = path_1.default.join(execCacheDir, options.key);
    console.log('cacheDir', path_1.default.parse(cacheDir).dir);
    const cachePath = path_1.default.join(cacheDir);
